        ...
        <div class="container">
            <div class="image rounded">
                <div class="card p-2 p-lg-4">
                    <div class="img mb-2">
                        <img src="{{ asset('/img/csrSch/image/icon.svg') }}" class="img-fluid" alt="">
                    </div>
            ...
            <div class="d-flex justify-content-center align-items-center" data-aos="zoom-in">
                ...
                <div class="checkbox">
                    <label for="checkbox_toggle nav-pills" class="slide" id="pills-tab" role="tablist">
                        ...
                        <label for="checkbox_toggle" class="text1" id="pills-home-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
                            aria-selected="true">
                            Mini Class
                        </label>
                        <label for="checkbox_toggle" class="text2" id="pills-profile-tab" data-bs-toggle="pill"
