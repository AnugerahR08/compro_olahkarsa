...
@section('title', 'Form Registrasi CSR mini School | Olahkarsa')

@section('content')

    <!-- ======= Form ======= -->
    <div class="container" id="csrmini">
        <div class="card rounded-5 shadow px-5">
            <h1 class="text-center mb-5">Form Registrasi CSR mini class</h1>
            <div class="row gx-5 gy-3 ">
                ...
                <div class="col-12">
                    <button class="btn btn-primary py-3 w-100" type="submit">Submit form</button>
                </div>
            </div>
        </div>
    </div>
