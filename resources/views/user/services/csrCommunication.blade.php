        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-up">
                <div class="col-md-8 mb-2">
                    <div class="image">
                        <img src="{{ asset('/img/services/csrComm/hero/hero.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-4 mb-2">
                    <div class="image">
                        <img src="{{ asset('/img/services/csrComm/hero/hero2.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row b1">
                <div class="col com1" data-aos="fade-right">
                    <img src="{{ asset('/img/services/csrComm/comm/img.png') }}" class="img-fluid card border-0" alt="">
                </div>
                <div class="col" data-aos="fade-left">
                    ...
                    <img src="{{ asset('/img/services/csrComm/comm/img.png') }}" class="img-fluid card border-0 mb-3 com2" alt="">
                    <div class="row row-cols-2 g-4" id="comm2">
                        <div class="col">
                            <div class="card p-3">
                                <div class="image mb-2">
                                    <img src="{{ asset('/img/services/csrComm/comm/icon1.svg') }}" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="col">
                            <div class="card p-3">
                                <div class="image mb-2">
                                    <img src="{{ asset('/img/services/csrComm/comm/icon2.svg') }}" class="img-fluid" alt="">
                                </div>
                                <div class="title mb-2">
                                    Virtual Event
                                </div>
                        ...
                        <div class="col">
                            <div class="card p-3">
                                <div class="image mb-2">
                                    <img src="{{ asset('/img/services/csrComm/comm/icon3.svg') }}" class="img-fluid" alt="">
                                </div>
                                <div class="title mb-2">
                                    Video Production
                                </div>
            ...
            <div class="row b2">
                <div class="col" data-aos="fade-right">
                    ...
                    <img src="{{ asset('/img/services/csrComm/comm/img2.png') }}" class="img-fluid card border-0 mb-3 com2" alt="">
                    <div class="row row-cols-2 g-4" id="comm2">
                        <div class="col">
                            <div class="card p-3">
                                <div class="image mb-2">
                ...
                <div class="col com1" data-aos="fade-left">
                    <img src="{{ asset('/img/services/csrComm/comm/img2.png') }}" class="img-fluid card border-0" alt="">
                </div>
            </div>
        </div>
    </div>
