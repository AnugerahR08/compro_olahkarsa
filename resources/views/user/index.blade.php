    ...
    {{-- <div class="" id="heroimg">
        <div class="row ms-0 me-0">
            <div class="col-xl-7 col-xxl-8 ps-0 pe-0 text-center">
                <img src="{{ asset('/img/home/hero/Image.png') }}" class="img-fluid" alt="...">
            </div>
            <div class="col-xl-5 col-xxl-4 ps-0 pe-0">
                <div class="row ms-0 me-0">
                    <div class="col-12 ps-0 pe-0 text-center">
                        <img src="{{ asset('/img/home/hero/Image3.png') }}" class="img-fluid" alt="...">
                    </div>
                    <div class="col-12 ps-0 pe-0 text-center">
                        <img src="{{ asset('/img/home/hero/Image2.png') }}" class="img-fluid" alt="...">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3">
                <div class="card bg-transparent shadow-0 border-0">
                    <div class="card-body text-white">
                        ...
                        <a class="card-footer bg-transparent border-0 shadow-none p-0 icon-link icon-link-hover" href="#">
                            Detail more
            ...
            <div class="card rounded-4">
                <div class="row">
                    ...
                    <div class="col-md-5 d-flex justify-content-end align-items-end">
                        <img src="{{ asset('/img/home/cta/cta.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container" id="strategic">
        <div class="row">
            <div class="col-md-6 str1" data-aos="fade-right">
                <img src="{{ asset('/img/home/strategic/image.png') }}" class="img-fluid" alt="...">
            </div>
    ...
    <div class="container" id="clients" data-aos="fade-up">
        ...
        <div class="container text-center">
            <div class="row row-cols-3 row-cols-lg-5 g-2 g-lg-3 cli1">
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien1.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien2.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien3.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien4.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien5.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien6.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien7.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien8.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien9.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien10.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien11.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien12.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien13.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien14.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col">
                    <div class="p-3">
                        <img src="{{ asset('/img/home/clien/clien15.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        ...
        <div id="our1">
            ...
            <div class="row justify-content-evenly mt-5">
                <div class="col-6 col-lg-6 card border-0 mb-3 rounded-4">
                    <a href="/home/portofolio">
                        <img src="{{ asset('/img/home/ourworks/image.png') }}" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <div class="card border-0 mb-3 rounded-4">
                                <a href="/home/portofolio">
                                    <img src="{{ asset('/img/home/ourworks/image.png') }}" class="img-fluid" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title text-dark">Corporate Website</h5>
                    ...
                    <div class="splide__slide card justify-content-center align-items-center mx-md-3">
                        ...
                        <div class="row">
                            <div class="col-3 col-lg-1">
                                <img src="{{ asset('/img/home/testimonial/Avatar.png') }}" class="img-fluid" alt="">
                            </div>
            ...
            <div class="card border rounded-3">
                <div class="container text-center">
                    <div class="row row-cols-3 row-cols-lg-6 g-2 g-lg-3 px-2 py-4 px-lg-4 py-lg-5 align-items-center">
                        <div class="col">
                            <div class="p-2">
                                <img src="{{ asset('/img/home/media/media1.svg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-2">
                                <img src="{{ asset('/img/home/media/media2.svg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-2">
                                <img src="{{ asset('/img/home/media/media3.svg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-2">
                                <img src="{{ asset('/img/home/media/media4.svg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-2">
                                <img src="{{ asset('/img/home/media/media5.svg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-2">
                                <img src="{{ asset('/img/home/media/media6.svg') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
